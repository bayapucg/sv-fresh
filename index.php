                ...
                <div class="homeslider">
                    <div class="content-slide">
                        <ul id="contenhomeslider">
                          <li><img alt="Funky roots" src="assets/data/slide.jpg"  /></li>
                          <li><img alt="Funky roots" src="assets/data/slide2.jpg"  /></li>
                          <li><img  alt="Funky roots" src="assets/data/slide3.jpg" /></li>
                        </ul>
                    </div>
                </div>
...
<div class="container ">
    <div class="row ">
		...
		<div class="col-xs-6 col-md-3 ">
			<div class="category-bg" style="margin:0 auto;" >
				<img class="img-resonsive" src="assets/images/grocery-cat-icon.png" alt="Grocery"/>
			</div>
